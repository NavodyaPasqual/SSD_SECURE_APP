...
import img from './img/ex11.png'
import img2 from './img/dmin_1.png'
      ...
      <div className="App">
        ...
        <nav className="navbar navbar-expand-lg navbar-light fixed-top">
          ...
          <div className="footer">
                  ...
                  <h5>All Rights Reserved, @Ruvindu Kaushalya_@Navodya Paskuel_@Buddi_Amarasinghe_@Tushan - RNTB</h5>
